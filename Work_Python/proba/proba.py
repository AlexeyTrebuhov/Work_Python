...
root.title('Крестики-нолики. Начинает компьютер')
...
def click(row, col):        # ставим крестик и считаем
    if game_run and field[row][col]['text'] == ' ': # если поле пустое можем поставить Х и поменять цвет
...
text_button = Button(text='Правила игры', font=('times', 14, 'bold'), background='#9CD8F0')
